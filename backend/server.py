...
# LLM
system_prompt = "You are Nextor, a Dutch RAG agent that helps navigate documents and provide accurate answers based on information you can retrieve from them. Answer all question based on retrieved information."
model = "gpt-5-nano"
# model = "gpt-5-mini"
