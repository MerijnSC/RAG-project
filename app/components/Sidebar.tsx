...
const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  return (
    <div className="w-80 bg-white border-r border-gray-200 flex flex-col h-full">
      ...
      {/* Actieve contextmappen sectie */}
      {viewMode === 'chat' && (
        <div className="px-4 mt-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-2">
              <File className="w-6 h-6 text-gray-500" />
              <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Actieve context</h2>
            </div>
            <button 
              ...
              {activeContextFolders.map((folder) => (
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <h3 className="text-sm text-gray-700">{folder.name}</h3>
                  </div>
                </div>
              ))
            }
        ...
        <div className="px-4 mt-4">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-sm font-semibold text-gray-700 uppercase tracking-wider">Mappen</h2>
            </div>
            <button 
          ...
          <div className="space-y-1">
            ...
            <div className="flex items-center space-x-2">
              ...
              <h2 className="text-sm text-gray-700">Algemene chats</h2>
            </div>
            </button>
            ...
            {folders.length > 0 ? (
              folders.map((folder) => (
                ...
                >
                  <div className="flex items-center space-x-2">
                    <Folder className="w-5 h-5" />
                    <h2 className="text-sm text-gray-700">{folder.name}</h2>
                  </div>
                </button>
              ))
            ) : (
              <p className="text-xs text-gray-400 px-3 py-2">Geen andere mappen beschikbaar</p>
            )}
          </div>
        </div>
      )}
        ...
        <div className="flex-1 p-4 overflow-y-auto">
          ...
          {recentChats.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-xs text-gray-400 mt-1">Start een nieuwe chat om te beginnen</p>
            </div>
          ) : (
            <div className="space-y-2">
        ...
        <div className="flex-1 p-4">
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h3 className="text-sm font-semibold  text-purple-900">Context Documenten</h3>
            </div>
        ...
        <div className="flex-1 p-4">
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <div className="flex items-center space-x-2 mb-2">
              ...
              <h3 className="text-sm font-semibold text-purple-900">Chat Geschiedenis</h3>
            </div>
            <p className="text-xs text-purple-700">
      ...
      <div className="p-4 border-t border-gray-200">
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div className="flex-1">
            <p className="text-sm font-medium text-gray-900">Demo Gebruiker</p>
